...
DescriptorProto.ExtensionRange.fields = {DescriptorProto.ExtensionRange_start_FIELD, DescriptorProto.ExtensionRange_end_FIELD}
...
DescriptorProto.nested_types = {DescriptorProto.ExtensionRange}
DescriptorProto.enum_types = {}
DescriptorProto.fields = {DescriptorProto_name_FIELD, DescriptorProto_field_FIELD, DescriptorProto_extension_FIELD, DescriptorProto_nested_type_FIELD, DescriptorProto_enum_type_FIELD, DescriptorProto_extension_range_FIELD, DescriptorProto_options_FIELD}
...
FieldDescriptorProto.Type.values = {FieldDescriptorProto.Type_TYPE_DOUBLE_ENUM,FieldDescriptorProto.Type_TYPE_FLOAT_ENUM,FieldDescriptorProto.Type_TYPE_INT64_ENUM,FieldDescriptorProto.Type_TYPE_UINT64_ENUM,FieldDescriptorProto.Type_TYPE_INT32_ENUM,FieldDescriptorProto.Type_TYPE_FIXED64_ENUM,FieldDescriptorProto.Type_TYPE_FIXED32_ENUM,FieldDescriptorProto.Type_TYPE_BOOL_ENUM,FieldDescriptorProto.Type_TYPE_STRING_ENUM,FieldDescriptorProto.Type_TYPE_GROUP_ENUM,FieldDescriptorProto.Type_TYPE_MESSAGE_ENUM,FieldDescriptorProto.Type_TYPE_BYTES_ENUM,FieldDescriptorProto.Type_TYPE_UINT32_ENUM,FieldDescriptorProto.Type_TYPE_ENUM_ENUM,FieldDescriptorProto.Type_TYPE_SFIXED32_ENUM,FieldDescriptorProto.Type_TYPE_SFIXED64_ENUM,FieldDescriptorProto.Type_TYPE_SINT32_ENUM,FieldDescriptorProto.Type_TYPE_SINT64_ENUM}
...
FieldDescriptorProto.Label.values = {FieldDescriptorProto.Label_LABEL_OPTIONAL_ENUM,FieldDescriptorProto.Label_LABEL_REQUIRED_ENUM,FieldDescriptorProto.Label_LABEL_REPEATED_ENUM}
...
FieldDescriptorProto.enum_types = {FieldDescriptorProto.Type, FieldDescriptorProto.Label}
FieldDescriptorProto.fields = {FieldDescriptorProto_name_FIELD, FieldDescriptorProto_number_FIELD, FieldDescriptorProto_label_FIELD, FieldDescriptorProto_type_FIELD, FieldDescriptorProto_type_name_FIELD, FieldDescriptorProto_extendee_FIELD, FieldDescriptorProto_default_value_FIELD, FieldDescriptorProto_options_FIELD}
...
EnumDescriptorProto.fields = {EnumDescriptorProto_name_FIELD, EnumDescriptorProto_value_FIELD, EnumDescriptorProto_options_FIELD}
...
MethodDescriptorProto.fields = {MethodDescriptorProto_name_FIELD, MethodDescriptorProto_input_type_FIELD, MethodDescriptorProto_output_type_FIELD, MethodDescriptorProto_options_FIELD}
...
FileOptions.OptimizeMode.values = {FileOptions.OptimizeMode_SPEED_ENUM,FileOptions.OptimizeMode_CODE_SIZE_ENUM,FileOptions.OptimizeMode_LITE_RUNTIME_ENUM}
...
FileOptions.enum_types = {FileOptions.OptimizeMode}
FileOptions.fields = {FileOptions_java_package_FIELD, FileOptions_java_outer_classname_FIELD, FileOptions_java_multiple_files_FIELD, FileOptions_java_generate_equals_and_hash_FIELD, FileOptions_optimize_for_FIELD, FileOptions_go_package_FIELD, FileOptions_cc_generic_services_FIELD, FileOptions_java_generic_services_FIELD, FileOptions_py_generic_services_FIELD, FileOptions_uninterpreted_option_FIELD}
...
MessageOptions.fields = {MessageOptions_message_set_wire_format_FIELD, MessageOptions_no_standard_descriptor_accessor_FIELD, MessageOptions_uninterpreted_option_FIELD}
...
FieldOptions.CType.values = {FieldOptions.CType_STRING_ENUM,FieldOptions.CType_CORD_ENUM,FieldOptions.CType_STRING_PIECE_ENUM}
...
FieldOptions.enum_types = {FieldOptions.CType}
FieldOptions.fields = {FieldOptions_ctype_FIELD, FieldOptions_packed_FIELD, FieldOptions_lazy_FIELD, FieldOptions_deprecated_FIELD, FieldOptions_experimental_map_key_FIELD, FieldOptions_weak_FIELD, FieldOptions_uninterpreted_option_FIELD}
...
UninterpretedOption.NamePart.fields = {UninterpretedOption.NamePart_name_part_FIELD, UninterpretedOption.NamePart_is_extension_FIELD}
...
UninterpretedOption.nested_types = {UninterpretedOption.NamePart}
...
SourceCodeInfo.Location.fields = {SourceCodeInfo.Location_path_FIELD, SourceCodeInfo.Location_span_FIELD, SourceCodeInfo.Location_leading_comments_FIELD, SourceCodeInfo.Location_trailing_comments_FIELD}
...
SourceCodeInfo.nested_types = {SourceCodeInfo.Location}
