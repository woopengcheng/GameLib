...
//	typedef void (* pfnClientCommand)(DBClient * pClient , INT32 argc , char ** argv);
	...
	public:
		...
		//5 Orm测试.
		static void		pfnHandleOrmHSetUser(DBClient * pClient ,  std::vector<std::string> & objParams);
		static void		pfnHandleOrmCollectionUpdate(DBClient * pClient ,  std::vector<std::string> & objParams);
