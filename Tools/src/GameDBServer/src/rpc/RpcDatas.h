...
{ 
	...
	GEN_PARAMTER_HELPER(Server::TestRpcData , PARAMETER_TYPE_USER_DEFINE_TestRpcData);
	GEN_PARAMTER_HELPER(Server::TestRpcData2 , PARAMETER_TYPE_USER_DEFINE_TestRpcData2);
}
